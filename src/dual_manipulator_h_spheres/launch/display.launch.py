...
def generate_launch_description():
    package_name = 'dual_manipulator_h_spheres'
    ...
    # 2. Convertir URDF → SDF usando ign sdf (respeta el joint 'world' correctamente)
    ...
    # 5. Spawn del robot desde SDF (fija el joint world correctamente)
